...
# A function to recognize speech in the audio file so that we don't repeat ourselves in other functions
...
def get_large_audio_transcription_on_silence(path):
    ...
    for i, audio_chunk in enumerate(chunks, start=1):
        ...
        # the given `folder_name` directory.
